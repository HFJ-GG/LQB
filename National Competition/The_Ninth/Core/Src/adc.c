...
uint8_t Scan_Btn(void)
{
	...
	else if((btn_temp > 0x0FFF / 14) && (btn_temp < 0x0FFF / 14 * 3))
	{
		return 2;
	}
	else if((btn_temp > 0x0FFF / 14 * 3) && (btn_temp < 0x0FFF / 14 * 5))
	{
		return 3;
	}
	else if((btn_temp > 0x0FFF / 14 * 5) && (btn_temp < 0x0FFF / 14 * 7))
	{
		return 4;
	}
	else if((btn_temp > 0x0FFF / 14 * 7) && (btn_temp < 0x0FFF / 14 * 9))
	{
		return 5;
	}
	else if((btn_temp > 0x0FFF / 14 * 9) && (btn_temp < 0x0FFF / 14 * 11))
	{
		return 6;
	}
	else if((btn_temp > 0x0FFF / 14 * 11) && (btn_temp < 0x0FFF / 14 * 13))
	{
		return 7;
	}
	else if((btn_temp > 0x0FFF / 14 * 13) && (btn_temp < 0x0F6F))
	{
		return 8;
	}
	else
